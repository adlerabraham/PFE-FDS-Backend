...
urlpatterns= [
    ...
    path('user/update/<int:pk>/',Update_user_view.as_view(), name='updateuser'),
    path('user/changepassword/<int:pk>/', Change_password_view.as_view(), name='changepassword'),
    path('verifyemail',VerifyEmail.as_view(), name='verifyemail'),
    path('user/register',Register_user_view.as_view(), name='registeruser'),
    path('user/resetpassword',Reset_password_send_email_view.as_view(), name='resetpassword'),
